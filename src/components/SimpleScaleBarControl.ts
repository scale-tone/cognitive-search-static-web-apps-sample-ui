...
export class SimpleScaleBarControl {

    private _map: any;
    private _scaleBar: any;
    private _options: any;
    private _updateScaleBar: any;
    ...
    */
     ...
     */
    _createDistanceString(num: number, isSmall: boolean) {
